...
Question 3: Task four
*/ 
public class RegistraterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox2.setText("Quizing");

        jCheckBox3.setText("Reading");

        jCheckBox4.setText("Standing");

        jCheckBox5.setText("Fishing");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistraterForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistraterForm().setVisible(true);
            }
        });
    }
